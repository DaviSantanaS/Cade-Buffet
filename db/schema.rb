...
ActiveRecord::Schema[7.1].define(version: 2024_05_11_024834) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.date "price_validity"
    t.string "payment_method"
    t.text "price_adjustment_description"
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_type_id"], name: "index_photos_on_event_type_id"
  end
  ...
  add_foreign_key "photos", "event_types"
end
